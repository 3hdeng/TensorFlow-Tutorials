...
#=========
def myplot(numFeatures,X_val, L3a_val, L3_val, m, i):    
        #====================================
        ...
        for k in range(0, numFeatures, step):
           ax=fig.add_subplot(3,8,k/step +9); ax.axis('off'); pyplot.imshow(L3a_val[m,:,:,k])#, cmap='gray')
           ax=fig.add_subplot(3,8,k/step +17); ax.axis('off'); pyplot.imshow(L3_val[m,:,:,k])#, cmap='gray')
