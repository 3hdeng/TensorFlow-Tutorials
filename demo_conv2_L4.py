...
with tf.Session() as sess:
    ...
    for i in range(10):
        ...
        result= sess.run([predict_op, L1a, L1, L2a, L2, L3a, L3, py_x], feed_dict={X: teX[test_indices],  
        Y: teY[test_indices], showimg:True})
        ...
        teY_val=teY[test_indices]
        print 'teY[0]= {0}'.format(teY_val[0])
        pyx_val= result[7]
        print 'pyx[0]'.format(pyx_val[0])
